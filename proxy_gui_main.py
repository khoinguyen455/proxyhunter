# VN: Đây là source chính đóng gói File .exe
# # EN: This is the main source code used to package the .exe file.
...
APPDATA_DIR = Path(os.getenv("APPDATA")) / "ProxyHunter"
APPDATA_DIR.mkdir(parents=True, exist_ok=True)

SETTINGS_FILE = APPDATA_DIR / "proxy_hunter_settings.json"
print(APPDATA_DIR)
# ── Light theme palette ───────────────────────────────────────────────────────
LIGHT = {
